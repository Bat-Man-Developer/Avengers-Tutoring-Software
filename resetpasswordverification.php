...
<body>
    ...
    <div class="login-container">
        ...
        <form action="resetpasswordverification.php" method="POST">
			...
			<div class="form-group">
                ...
                <input type="password" id="password" name="flduserpassword" required>
            </div>
			<div class="form-group">
                <label for="confirmpassword">Confirm Password</label>
                <input type="password" id="confirmpassword" name="flduserconfirmpassword" required>
            </div>
            <input type="hidden" name="flduseremail" value="<?php echo $_GET['flduseremail']; ?>">
            <button type="submit" name="resetPasswordVerificationBtn" class="submit-btn">Verify</button>
        </form>
