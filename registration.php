    ...
    <div class="login-container">
        ...
        <form action="registration.php" method="POST">
			...
			<div class="form-group">
				...
				<select class="form-control" id="country" name="fldusercountry" size="1" value="" required>
					<option value="">Select Country...</option>
				</select>
			</div><br>
			<div class="form-group">
				<label for="registrationzone">Province</label>
				<select class="form-control" id="zone" name="flduserzone" size="1" value="" required>
					<option value="">Select Province...</option>
				</select>
			</div><br>
			<div class="form-group">
				<label for="registrationcity">City</label>
				<select class="form-control" id="city" name="fldusercity" size="1" value="" required>
					<option value="">Select City...</option>
				</select>
			</div><br>
			<div class="form-group">
				<label for="registrationlocalarea">Local Area</label>
				<input type="text" class="form-control" id="registrationlocalarea" name="flduserlocalarea" placeholder="Local Area" required/>
			</div>
			<div class="form-group">
				<label for="registrationstreetaddress">Street Address</label>
			...
			<div class="form-group">
				<label for="registrationpostalcode">Postal Code</label>
            ...
            <button type="submit" name="registrationBtn" class="submit-btn">Create Account</button>
            <div class="links">
